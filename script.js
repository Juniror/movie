...
const hori_img = ["asset/horizontal/jumanji.jpg", "asset/horizontal/snowwhite.jpg"]
...
const type = {
  ...
  all: [
    ...
    },
    {
      ...
      detail:
        "ซื้อบัตรชมภาพยนตร์ เรื่อง GRANDE MAISON PARIS รับส่วนลดตั๋วหนังมูลค่า 50 บาท / ที่นั่ง เพียงลูกค้าแสดงใบเสร็จจากร้านอาหาร HITORI SHABU",
    ...
    },
    {
      ...
      detail:
        'Presale Promotion ภาพยนตร์เรื่อง ซองแดงแต่งผี : จำหน่ายบัตรชมภาพยนตร์ราคาพิเศษในรูปแบบ "COLLECTIBLE TICKET SPECIAL EDITION"',
...
// Find the goSeat function and modify it to check for login before proceeding
function goSeat() {
  // Check if user is logged in
  if (!islogin) {
